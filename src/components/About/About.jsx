  ...
  return (
    <div className={`about animation ${isVisible ? "animation-active" : ""}`} ref={aboutRef}>
        <div className="aboutTxt">
          ...
          <h4 className="randomAboutP"><b>Software Engineer</b>  exploring <span style={{color: "rgb(217, 119, 7)"}}>Python, Rust and Go</span></h4>
          ...
          <div className="techStack">
            {
              listTechStack.map((techStack, key) => (
                <p key={key}><i style={{color: "rgb(217, 119, 7)"}}><TbCaretRight /></i>{techStack.name}</p>
              ))  
            }
